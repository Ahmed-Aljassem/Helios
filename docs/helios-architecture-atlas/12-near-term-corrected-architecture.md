...
This chapter is a **PROPOSED** baseline, not a description of merged code. Near-term means COR-01, COR-02, COR-03, COR-04, COR-05, COR-06, COR-07, COR-08; PRO-01, PRO-02, PRO-03, PRO-04, PRO-05, PRO-06; VER-01, VER-02, VER-03, VER-04, VER-05, VER-06; BEN-01, BEN-02, BEN-03, BEN-04, BEN-05, BEN-06, BEN-07; DOC-01, DOC-02, DOC-03; and INF-01, INF-02, INF-03. COR-09, BEN-08, BEN-09, BEN-10, DOC-04, and FUT-01, FUT-02, FUT-03, FUT-04, FUT-05, FUT-06, FUT-07 remain later work or research.
<a id="a12-01"></a>
...
| Source evidence | [types.hpp](../../include/types.hpp), [itch_parser.hpp](../../include/itch_parser.hpp), [book_replay.hpp](../../include/book_replay.hpp), [orderbook.hpp](../../include/orderbook.hpp), [orderbook.cpp](../../src/orderbook.cpp) |
...
- **Important edges**
  ...
  - R -->|validated mutation command| B
  - B -->|success/failure invariant result| E
- **What exists:** The backlog entries supporting the corrected runtime baseline proposal exist as planning evidence.
- **What does not exist:** The proposed corrected runtime baseline components remain unimplemented until their promotion gates pass.
...
| Evidence/status | PROPOSED backlog architecture only. |
| Source evidence | [test_orderbook.cpp](../../tests/test_orderbook.cpp), [itch_parser.hpp](../../include/itch_parser.hpp), [orderbook.hpp](../../include/orderbook.hpp) |
| Backlog | [VER-01](../../ENGINEERING_BACKLOG.md#ver-01--build-protocol-golden-fixtures), [VER-02](../../ENGINEERING_BACKLOG.md#ver-02--build-a-reference-book-and-differential-invariant-harness), [VER-03](../../ENGINEERING_BACKLOG.md#ver-03--replace-the-invalid-allocation-check-with-a-trustworthy-methodology), [VER-04](../../ENGINEERING_BACKLOG.md#ver-04--repair-workload-lifecycle-accounting), [VER-05](../../ENGINEERING_BACKLOG.md#ver-05--add-sanitizer-fuzzing-and-boundary-verification-strategy), [INF-01](../../ENGINEERING_BACKLOG.md#inf-01--establish-a-compiler-and-verification-ci-matrix) |
| Findings | [HEL-008](11-current-technical-debt-overlay.md#hel-008), [HEL-009](11-current-technical-debt-overlay.md#hel-009), [HEL-011](11-current-technical-debt-overlay.md#hel-011), [HEL-022](11-current-technical-debt-overlay.md#hel-022), [HEL-034](11-current-technical-debt-overlay.md#hel-034), [HEL-046](11-current-technical-debt-overlay.md#hel-046) |
| Related atlas material | — |
...
- **Important edges**
  ...
  - C --> D
  - D --> S
- **What exists:** The backlog entries supporting the verification pipeline proposal exist as planning evidence.
- **What does not exist:** The proposed verification pipeline components remain unimplemented until their promotion gates pass.
...
- **Important edges**
  ...
  - T --> A
  - A --> D
- **What exists:** The backlog entries supporting the benchmark and evidence pipeline proposal exist as planning evidence.
- **What does not exist:** The proposed benchmark and evidence pipeline components remain unimplemented until their promotion gates pass.
...
flowchart LR
    ...
    L["[RESEARCH] later COR-09, BEN-08 through BEN-10, DOC-04, and FUT work"]:::research
    C -.-> S0
    S0 --> S1
    S1 --> S2
    S2 --> S3
...
- **Important edges**
  ...
  - S2 --> S3
  - S3 -.->|only after acceptance| L
- **What exists:** The backlog entries supporting the current-to-corrected migration proposal exist as planning evidence.
- **What does not exist:** The proposed current-to-corrected migration components remain unimplemented until their promotion gates pass.
