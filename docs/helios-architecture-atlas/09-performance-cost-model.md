...
- **What exists:** Each CURRENT stage in the add cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the add cost path is not a measurement, and the diagram infers no nanosecond value.
...
- **What exists:** Each CURRENT stage in the cancel cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the cancel cost path is not a measurement, and the diagram infers no nanosecond value.
...
- **What exists:** Each CURRENT stage in the reduce cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the reduce cost path is not a measurement, and the diagram infers no nanosecond value.
...
| Source evidence | [orderbook.hpp](../../include/orderbook.hpp), [orderbook.cpp](../../src/orderbook.cpp), [price_level.hpp](../../include/price_level.hpp), [price_level.cpp](../../src/price_level.cpp), [object_pool.hpp](../../include/object_pool.hpp), [order.hpp](../../include/order.hpp), [itch_parser.hpp](../../include/itch_parser.hpp), [book_replay.hpp](../../include/book_replay.hpp), [benchmark_orderbook.cpp](../../benchmarks/benchmark_orderbook.cpp), [itch_book_replay.cpp](../../benchmarks/itch_book_replay.cpp) |
| Backlog | [COR-06](../../ENGINEERING_BACKLOG.md#cor-06--define-mutation-exception-safety-guarantees), [BEN-03](../../ENGINEERING_BACKLOG.md#ben-03--replace-the-add-only-headline-with-a-workload-portfolio), [COR-01](../../ENGINEERING_BACKLOG.md#cor-01--establish-a-lossless-price-domain-model) |
...
- **What exists:** Each CURRENT stage in the replace cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the replace cost path is not a measurement, and the diagram infers no nanosecond value.
...
- **What exists:** Each CURRENT stage in the full execution cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the full execution cost path is not a measurement, and the diagram infers no nanosecond value.
...
| Source evidence | [orderbook.hpp](../../include/orderbook.hpp), [orderbook.cpp](../../src/orderbook.cpp), [price_level.hpp](../../include/price_level.hpp), [price_level.cpp](../../src/price_level.cpp), [object_pool.hpp](../../include/object_pool.hpp), [order.hpp](../../include/order.hpp), [itch_parser.hpp](../../include/itch_parser.hpp), [book_replay.hpp](../../include/book_replay.hpp), [benchmark_orderbook.cpp](../../benchmarks/benchmark_orderbook.cpp), [itch_book_replay.cpp](../../benchmarks/itch_book_replay.cpp) |
| Backlog | [BEN-03](../../ENGINEERING_BACKLOG.md#ben-03--replace-the-add-only-headline-with-a-workload-portfolio), [COR-04](../../ENGINEERING_BACKLOG.md#cor-04--separate-reduce-and-quantity-increase-priority-semantics) |
...
- **What exists:** Each CURRENT stage in the partial execution cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the partial execution cost path is not a measurement, and the diagram infers no nanosecond value.
...
| Source evidence | [orderbook.hpp](../../include/orderbook.hpp), [orderbook.cpp](../../src/orderbook.cpp), [price_level.hpp](../../include/price_level.hpp), [price_level.cpp](../../src/price_level.cpp), [object_pool.hpp](../../include/object_pool.hpp), [order.hpp](../../include/order.hpp), [itch_parser.hpp](../../include/itch_parser.hpp), [book_replay.hpp](../../include/book_replay.hpp), [benchmark_orderbook.cpp](../../benchmarks/benchmark_orderbook.cpp), [itch_book_replay.cpp](../../benchmarks/itch_book_replay.cpp) |
| Backlog | [BEN-03](../../ENGINEERING_BACKLOG.md#ben-03--replace-the-add-only-headline-with-a-workload-portfolio), [BEN-09](../../ENGINEERING_BACKLOG.md#ben-09--measure-bitmap-refresh-complexity-and-alternatives), [COR-03](../../ENGINEERING_BACKLOG.md#cor-03--define-zero-quantity-lifecycle-semantics), [COR-08](../../ENGINEERING_BACKLOG.md#cor-08--separate-reconstruction-and-matching-semantics) |
...
- **What exists:** Each CURRENT stage in the long sweep cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the long sweep cost path is not a measurement, and the diagram infers no nanosecond value.
...
| Source evidence | [orderbook.hpp](../../include/orderbook.hpp), [orderbook.cpp](../../src/orderbook.cpp), [price_level.hpp](../../include/price_level.hpp), [price_level.cpp](../../src/price_level.cpp), [object_pool.hpp](../../include/object_pool.hpp), [order.hpp](../../include/order.hpp), [itch_parser.hpp](../../include/itch_parser.hpp), [book_replay.hpp](../../include/book_replay.hpp), [benchmark_orderbook.cpp](../../benchmarks/benchmark_orderbook.cpp), [itch_book_replay.cpp](../../benchmarks/itch_book_replay.cpp) |
| Backlog | [PRO-01](../../ENGINEERING_BACKLOG.md#pro-01--introduce-structured-framing-and-decode-outcomes), [PRO-06](../../ENGINEERING_BACKLOG.md#pro-06--specify-portable-file-mapping-and-prefault-behavior), [BEN-07](../../ENGINEERING_BACKLOG.md#ben-07--reinvestigate-latency-tails-with-correlated-evidence), [VER-06](../../ENGINEERING_BACKLOG.md#ver-06--establish-artifact-and-replay-provenance) |
...
- **What exists:** Each CURRENT stage in the parse cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the parse cost path is not a measurement, and the diagram infers no nanosecond value.
...
- **What exists:** Each CURRENT stage in the symbol filter cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the symbol filter cost path is not a measurement, and the diagram infers no nanosecond value.
...
- **What exists:** Each CURRENT stage in the complete replay cost path is visible in tracked source; historical evidence remains explicitly labeled.
- **What does not exist:** The research node in the complete replay cost path is not a measurement, and the diagram infers no nanosecond value.
